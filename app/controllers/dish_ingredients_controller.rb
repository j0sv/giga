class DishIngredientsController < ApplicationController
  ...
  def create
    ...
    dish.dish_ingredients.create(ingredient: ingredient, quantity: params[:quantity])
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to request.referer, notice: 'Dish ingredient was successfully destroyed.' }
  ...
  private
    ...
    def dish_ingredient_params
      params.require(:dish_ingredient).permit(:quantity)
    end
end
